...
class App extends Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      window.localStorage.image_hosting_type = "GitHub";
      window.localStorage.github_image_hosting = JSON.stringify({
        username: "wugaoliang1116",
        repo: "picture",
        token: "4d29f10b741fd19255fa63b31399971707cddccb",
        jsdelivr: "fasle",
      });
    }, 3000);
    try {
  ...
  setCustomImageHosting = () => {
    ...
    if (window.localStorage.getItem(IMAGE_HOSTING_TYPE) === null) {
      ...
      window.localStorage.setItem(IMAGE_HOSTING_TYPE, "GitHub");
    }
  };
